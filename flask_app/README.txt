...
This Python Flask WebApp is a simple e-mail address search engine. It accepts the name of an individual as the query 
criterion at the search bar and returns the corresponding e-mail address as it is stored in the "Contacts" postgresql 
